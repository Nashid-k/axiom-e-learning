...
export default function LandingPage() {
    ...
    return (
        <div className="bg-[var(--color-bg)] text-[var(--fg-primary)] min-h-screen relative overflow-hidden">
            ...
            <main className="max-w-5xl mx-auto px-6 pt-32 pb-24 text-center relative z-10">
                <div className="inline-block px-4 py-1.5 mb-8 border border-[var(--surface-border)] rounded-full text-[10px] font-black tracking-[0.25em] text-[var(--color-cyan)] uppercase bg-[var(--surface-border)] shadow-[0_0_15px_rgba(99,102,241,0.1)]">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-24">
                    ...
                    <Link href="#features">
                        <Button variant="outline" size="lg" className="px-8 border-[var(--surface-border)] text-[var(--fg-primary)] hover:bg-[var(--surface-border)]">
                            Explore Console
                        </Button>
                    </Link>
                </div>
                ...
                {/* Product preview */}
                <div className="mt-16 border border-[var(--surface-border)] rounded-2xl overflow-hidden shadow-[0_25px_60px_rgba(0,0,0,0.8)] bg-gradient-to-b from-[var(--surface-raised)] to-black/40 text-left transition-all duration-500 hover:border-[var(--color-primary)]/30 max-w-4xl mx-auto group">
                    <div className="flex items-center gap-2 px-5 py-4 border-b border-[var(--surface-border)] bg-[var(--surface-base)]">
                    ...
                    <div className="p-8 grid grid-cols-1 sm:grid-cols-3 gap-6 relative">
                        ...
                        {[
                            ...
                            <div key={path.name} className="p-5 border border-[var(--surface-border)] rounded-xl bg-[var(--surface-base)] transition-all duration-300 hover:translate-y-[-4px] hover:border-[var(--surface-border-active)] hover:shadow-lg relative z-10">
                                ...
                                <div className="font-bold text-[var(--fg-primary)] text-base mb-4">{path.name}</div>
            ...
            {/* Social proof strip */}
            <div className="py-12 border-t border-b border-[var(--surface-border)] my-12 text-center max-w-4xl mx-auto px-6 relative z-10">
            ...
            <section id="features" className="max-w-7xl mx-auto px-6 py-24 relative z-10">
                <BentoGrid className="grid-cols-1 md:grid-cols-3 gap-6">
                    {[
                        ...
                        <BentoCard key={i} size="medium" className={cn("flex flex-col justify-center border-[var(--surface-border)] bg-gradient-to-br from-[var(--surface-raised)] to-transparent rounded-2xl", feature.color)}>
                            <div className="w-12 h-12 rounded-xl bg-[var(--surface-raised)] border border-[var(--surface-border)] flex items-center justify-center text-2xl mb-6 shadow-md">
                                {feature.icon}
                            </div>
                            <h3 className="text-xl font-bold mb-3 tracking-tight text-[var(--fg-primary)] font-display">
                                {feature.title}
                            </h3>
            ...
            <footer className="py-16 px-6 border-t border-[var(--surface-border)] bg-[var(--surface-base)] relative z-10">
                <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
                    <div className="flex items-center gap-3">
                        <div className="p-1.5 rounded-lg bg-[var(--surface-raised)] border border-[var(--surface-border)]">
                            <AxiomLogo className="w-5 h-5" />
                        </div>
                        <span className="font-extrabold text-xl tracking-tight text-[var(--fg-primary)] font-display">AXIOM</span>
                    </div>
