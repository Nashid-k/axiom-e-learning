...
export default function AppError({ error, reset }: AppErrorProps) {
    return (
        <div className="flex flex-col items-center justify-center p-16 text-center bg-[var(--surface-raised)] border border-[var(--surface-border)] rounded-md relative overflow-hidden">
            <div className="absolute inset-0 bg-accent/5 -z-10" />
            
            <div className="w-16 h-16 bg-accent/10 border border-accent/20 rounded-2xl flex items-center justify-center mb-8 shadow-xl shadow-accent/10">
            ...
            <h2 className="text-3xl font-black tracking-tighter mb-4 text-[var(--fg-primary)]">System Override Detected</h2>
