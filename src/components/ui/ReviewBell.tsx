    ...
    return (
        <>
            <button
                ...
                className="fixed bottom-6 left-6 z-[45] w-12 h-12 rounded-md bg-black dark:bg-white text-white dark:text-black flex items-center justify-center border border-neutral-200 dark:border-neutral-800 transition-none group"
                            ...
                            {dueTopics.map((topic) => (
                                <div key={topic.id} className="p-4 border border-neutral-50 dark:border-neutral-950 bg-neutral-50 dark:bg-neutral-900 rounded-md flex items-center justify-between group">
                                    <div className="flex-1 min-w-0 mr-4">
                                        ...
                                        <p className="text-[10px] font-bold uppercase tracking-widest text-[var(--color-primary)] mt-1">Review Now</p>
                                    </div>
                                    <button
                                        onClick={() => toggleStudied(topic.id)}
                                        className="w-8 h-8 rounded-md border border-neutral-200 dark:border-neutral-800 flex items-center justify-center text-neutral-400 hover:text-[var(--color-primary)] hover:border-[var(--color-primary)] transition-none"
