export const TYPESCRIPT_PROJECTS = {
    fileName: "typescript-projects",
    rules: {
        category: "TypeScript",
    ...
    individualProjects: [
        {
            ...
            concepts: ["Material Labeling (Basic Types)", "The Strict Foreman (TSC)"]
        },
        {
            id: 2,
            tsLevel: "typescript-1",
            ...
            concepts: ["Building Contracts (Interfaces)", "Site Rules (Strict Objects)"]
        },
        {
            id: 3,
            ...
            concepts: ["Adjustable Wrenches (Generics)", "Constraint Chains"]
        },
        {
            id: 4,
            tsLevel: "typescript-2",
            ...
            concepts: ["The Site Guards (Type Guards)", "Discriminated Unions"]
        },
        {
            id: 5,
            ...
            concepts: ["Smart Kitchen (React + TS)", "Typed Props & Hooks"]
        },
        {
            id: 6,
            tsLevel: "typescript-3",
            ...
            concepts: ["Secure Warehouse (Node + TS)", "Blueprint Verification (Zod)"]
        }
    ]
};
