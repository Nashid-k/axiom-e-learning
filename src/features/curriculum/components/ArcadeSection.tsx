                ...
                {allGames.map((game, idx) => (
                    ...
                    >
                        <div className="flex justify-between items-start mb-4">
                            <div className="w-8 h-8 rounded-sm border border-neutral-200 dark:border-neutral-800 flex items-center justify-center text-xs font-bold text-neutral-400">
                                {game.title.charAt(0)}
                            </div>
                        ...
                        <div>
                            <h3 className="font-bold text-sm mb-1 group-hover:text-brand-500 transition-none truncate">{game.title}</h3>
