        ...
        <div className="max-w-7xl mx-auto px-6 mb-12">
            <div className="p-6 border border-neutral-200 dark:border-neutral-800 rounded-md bg-white dark:bg-black">
                <div className="flex items-center justify-between mb-6">
                    ...
                    <span className="text-[10px] font-bold text-brand-500 uppercase tracking-widest">{reviewDueTopics.length} Due</span>
                </div>
                    ...
                    {reviewDueTopics.map(topic => {
                        ...
                        return (
                            <button
                                ...
                                className="group inline-flex items-center gap-2 px-3 py-1.5 text-[10px] font-bold uppercase tracking-widest rounded-sm bg-neutral-50 dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 text-neutral-500 hover:text-black dark:hover:text-white hover:border-neutral-400 dark:hover:border-neutral-600 transition-none"
                            >
